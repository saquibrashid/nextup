...
| `T-MOCK-002` | E2E | Desktop sidebar and phone navigation geometry, local serif heading, keyboard-reachable 44px service chips, shared filter-panel state, full catalog reflow and axe. `tests/e2e/refinedLibrary.spec.ts`. |
