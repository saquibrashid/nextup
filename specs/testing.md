...
| `T-POL-003` | E2E | Responsive capture stage framing, review evidence/identity/action alignment, 192x288 desktop grid vs 72x108 compact artwork, reduced motion and screenshots. `tests/e2e/guidedCapture.spec.ts`, `tests/e2e/groupedReview.spec.ts`, `tests/e2e/refinedLibrary.spec.ts`; existing overflow, target-size and axe assertions remain. |
