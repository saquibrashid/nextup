...
| NFR-010 | No automated request to a streaming service | Only three outbound destinations exist: TMDB, Azure OpenAI and Azure AI Vision | Outbound host allow-list test (US-038 AC-2/AC-5), `T-SEC-031` |
