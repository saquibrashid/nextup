...
/** §7c's closed set (ADR-0013 Revision 4, #369; Plus from TASK-255; Clipboard, Folder and Refresh from TASK-260), transcribed. A 28th icon fails `T-UI-030b`. */
const CLOSED_SET = [
  'AlphabetIcon',
  'BookmarkIcon',
  'BrandIcon',
...
describe('T-UI-030 — every icon inherits its colour and declares none of its own', () => {
  ...
  it('T-UI-030b: the exported set is exactly the 27 §7c names', () => {
